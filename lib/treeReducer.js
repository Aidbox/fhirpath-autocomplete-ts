...
(function (FHIRTokenType) {
    ...
    FHIRTokenType[FHIRTokenType["Type"] = 3] = "Type";
    FHIRTokenType[FHIRTokenType["Literal"] = 4] = "Literal";
    FHIRTokenType[FHIRTokenType["ExternalConstant"] = 5] = "ExternalConstant";
    FHIRTokenType[FHIRTokenType["NonTriggeringCharacter"] = 6] = "NonTriggeringCharacter";
...
class FHIRPathAutocompleteVisitor extends AbstractParseTreeVisitor {
    constructor(cursor) {
        ...
        this.visitParamList = (ctx) => {
            var _a;
            let child = ((_a = ctx.children) !== null && _a !== void 0 ? _a : []).find(c => this.inRange(c));
            if (child) {
